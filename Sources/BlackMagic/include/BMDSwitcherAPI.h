...
enum _BMDSwitcherMixEffectBlockEventType {
    bmdSwitcherMixEffectBlockEventTypeProgramInputChanged        = 'pgiC',
    bmdSwitcherMixEffectBlockEventTypePreviewInputChanged        = 'pviC',
    bmdSwitcherMixEffectBlockEventTypeTransitionPositionChanged  = 'tspC',
    bmdSwitcherMixEffectBlockEventTypeTransitionFramesRemainingChanged = 'tfrC',
    bmdSwitcherMixEffectBlockEventTypeInTransitionChanged        = 'iitC',
    bmdSwitcherMixEffectBlockEventTypeFadeToBlackFramesRemainingChanged = 'ffrC',
    bmdSwitcherMixEffectBlockEventTypeInFadeToBlackChanged       = 'ifbC',
    bmdSwitcherMixEffectBlockEventTypePreviewLiveChanged         = 'pvlC',
    bmdSwitcherMixEffectBlockEventTypePreviewTransitionChanged   = 'pvtC',
    bmdSwitcherMixEffectBlockEventTypeInputAvailabilityMaskChanged = 'avmC',
    bmdSwitcherMixEffectBlockEventTypeFadeToBlackRateChanged     = 'fbrC',
    bmdSwitcherMixEffectBlockEventTypeFadeToBlackFullyBlackChanged = 'fbbC',
    bmdSwitcherMixEffectBlockEventTypeFadeToBlackInTransitionChanged = 'fbtC'
};
